...
import 'package:feh_tool/global/enum/stats.dart';
...
import 'package:feh_tool/models/move_type/move_type.dart';
...
class HomePageController extends GetxController {
  ...
  GlobalKey<CustomListViewState<Person>> listKey =
      GlobalKey<CustomListViewState<Person>>();
  ...
  void sortBy(List<Person> source, SortKey key) {
    ...
    switch (key) {
      ...
      case SortKey.hp:
        ...
        listKey.currentState!.showHeader = false;
        grouped.clear();
        grouped["HP"] = [];
        _all.forEach((person) {
          grouped["HP"]!.add(person);
        });
        break;
      case SortKey.atk:
