...
class _FilterDrawState extends ConsumerState<FilterDraw> {
  ...
  void initState() {
    weaponTypes =
        ref.read(repoProvider).requireValue.cacheWeaponTypes.values.toList();
                              ...
                              Padding(
                                ...
                                child: _TagChip(
                                  label: UniImage(
                                    path: p
                                        .join("assets", "weapon",
                                            "${weaponTypes[i * 4 + j].index}.webp")
                                        .replaceAll(r"\", "/"),
                                    height: 40,
                                  ),
                                  filterType: WeaponTypeEnum
                                      .values[weaponTypes[i * 4 + j].index],
                                  id: widget.id,
                                ),
                              ),
                          ],
                          ...
                          ListTile(
                            title: Wrap(
                              ...
                              children: [
                                _TagChip(
                                  label: const Text("神装"),
                                  filterType: PersonTypeEnum.isResplendent,
                                  id: widget.id,
                                ),
                                _TagChip(
                                  label: const Text("舞娘"),
